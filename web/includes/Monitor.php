...
public static function getStateString($option) {
  ...
  protected $defaults = array(
    ...
    'Decoding'  => 'Always',
    'ZlMediaKitEnabled'   => array('type'=>'integer','default'=>0),
    'ZlMediaKitType'   => 'WebRTC',
    'ZlMediaKitAudioEnabled'   => array('type'=>'boolean','default'=>0),
...
#(($options['height'] and ($options['height'] != '0px')) ? 'height: '.$options['height'].';' : '').
    ...
    } else if ($this->JanusEnabled() or ($this->RTSP2WebEnabled() and ZM_RTSP2WEB_PATH) or ($this->ZlMediaKitEnabled() and ZM_ZLMEDIAKIT_PATH)) {
